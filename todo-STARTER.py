...
l1= Label(mf, text= "TO DO: ", bg= "grey", fg= "white")
l1.grid(row= 0, column= 0, sticky= "ew")

lf= Frame(mf, bg= "light grey", padx= 5, pady= 5)
...
class ListItem():
    def __init__(self, row):
        ...
        self.cb= Checkbutton(lf, textvariable= self.cb_var, bg= "grey", command= self.update, onvalue= 1, offvalue= 0, variable= self.cb_state_var)

        
        self.cb.grid(row= row, column=0, sticky= "W")
        self.ent= Entry(lf, textvariable=self.ent_var, bg= "grey")
    ...
    def destroy_entry(self, event):
        ...
        self.trash= Button(lf, image= trashpic, relief= "raised", bg= "grey", justify= "right", command= self.delete)
